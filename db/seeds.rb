...
rental_contract1 = RentContract.create(rental_id: 3, user_id: 1)
rental_contract2 = RentContract.create(rental_id: 2, user_id: 5)
rental_contract3 = RentContract.create(rental_id: 4, user_id: 4)